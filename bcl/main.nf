...
// get docker ncores, not nextflow env ncores!!
 ...
 params.runfolder   = ""
 params.samplesheet = "${params.runfolder}/SampleSheet.csv" // or you can define based on name you use
...
process bcl {
    ...
    input:
        path run_x from runfolder_bcl
        path run_y from samplesheet_ch
